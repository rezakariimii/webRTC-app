...
export declare namespace AgoraChat {
	...
	class Connection {
        ...
        */
		 ...
		 *
		 * @note
		 * If either `needAffiliations` or `needAffiliations` is set, when you get data with pagination, the current page number (pageNum) starts from 0 and you can get a maximum of 20 groups (pageSize) on each page.
		 *
		 * If neither of the parameters is set, when you get data with pagination, the current page number (pageNum) starts from 1 and you can get a maximum of 500 groups (pageSize) on each page.
		 *
		 * ```typescript
		...
		setChatRoomAttributes(
			...
			params: {
				 ...
				 * `false`: No. */
				autoDelete?: boolean;
				/** Whether to allow a member to overwrite custom chat room attributes set by others.
				 * `true`: Yes.
				 * （Default）`false`: No. */
				isForced?: boolean;
			}
